...
const BANCA = [   // banca del parque, de segunda mano (14 × 12)
  "..............",
  "..............",
  ".mmmmmmmmmmmm.",
  ".m..........m.",
...
const ARDILLA = [   // ardilla acaparadora: guarda lo del año pasado (13 × 12)
  ".........ttt.",
  "........tt.tt",
  "..bb....tt.tt",
  ".bbbb...tt.tt",
...
const MONUMENTO = [  // jefe de Jesús María: el monumento que se cuenta dos veces (20 × 16)
  "........cccc........",
  ".......cccccc.......",
  ".......ckkckc.......",
  ".......cccccc.......",
...
const GLOBO = [   // globo de la feria: se queda con las utilidades retenidas (12 × 12)
  "....rrrr....",
  "...rrrrrr...",
  "..rrrrrrrr..",
  "..rrrrwwrr..",
...
const DIANA = [   // tiro al blanco: revende las entradas de la feria (12 × 12)
  "............",
  "...rrrrrr...",
  "..rwwwwwwr..",
  ".rwwrrrrwwr.",
...
const ALGODON = [   // algodón de azúcar: vendido sin boleta de por medio (12 × 12)
  "............",
  "...ppppp....",
  "..ppppppp...",
  ".ppppppppp..",
...
const PAYASO = [  // jefe de Lince: el payaso que se pierde de ida y de vuelta (20 × 16)
  "...rr..........rr...",
  "..rrrr........rrrr..",
  "..rrrrr......rrrrr..",
  "....ccccccccccc.....",
...
const MALETIN = [   // maletín de oficina: se le pierde el año base (12 × 12)
  "............",
  "....kkkk....",
  "....k..k....",
  "..bbbbbbbb..",
...
const CORBATA = [   // corbata de San Isidro: se desinfla pero no baja (12 × 12)
  "............",
  "...ww..ww...",
  "...wwwwww...",
  "....rrrr....",
...
const CAFE = [   // café del Olivar: nunca sabe si entra a la canasta (12 × 12)
  "............",
  "...vvv......",
  "..v.v.v.....",
  "............",
...
const EJECUTIVO = [  // jefe de San Isidro: el ejecutivo de Laspeyres (20 × 16)
  ".......kkkkkk.......",
  "......kkkkkkkk......",
  "......ccccccccc.....",
  ".....ccccccccccc....",
